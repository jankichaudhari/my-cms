...
(function ($) {
    ...
    $.widget('blueimpUI.fileupload', $.blueimp.fileupload, {
        ...
        options: {
            ...
            uploadTemplate: $('#template-download'),
        ...
        _adjustMaxNumberOfFiles: function (operand) {
            if (typeof this.options.maxNumberOfFiles === 'number') {
                ...
                if (this.options.maxNumberOfFiles < 1) {
					...
					/*var temp = $('.template-download ui-state-error').remove();
					alert(temp);*/
					$('.ui-button-text').html('');
					$('.fileinput-button').attr('id','inputButtonHide');
					/*$('.ui-button-text').html('<a href="">change picture</a>');*/
					//alert(temp);
                } else {
                    this._enableFileInputButton();
                }
        ...
        _hasError: function (file) {
            ...
            if (!(this.options.acceptFileTypes.test(file.type) ||
                ...
                var template = $('.template-download').html();
				if(template==null)
				{
					return 'acceptFileTypesNoImg';
				}
				else
				{
			...
			if (((this.options.acceptFileTypes.test(file.type) ||
                    this.options.acceptFileTypes.test(file.name))) && (!(this.options.maxFileSize &&
                    file.size > this.options.maxFileSize)) && (!(typeof file.size === 'number' && file.size < this.options.minFileSize))) 
			{
        ...
        _renderUpload: function (files) {
			...
			//tmpl.find('.template-download').remove();
        ...
        _startHandler: function (e) {
            e.preventDefault();
            var tmpl = $(this).closest('.template-download'),
                data = tmpl.data('data');
