...
<div style="width:650px;"><h4>Regular Invoices</h4></div>
<div style="width:650px;" id="errorMsg_i"></div>
<!--Title Row-->
<div style="width:650px;" id="smallText" align="right">
	<a href="javascript:void(0);" onclick="javascript:newForm(this);" id="regular_in_<?php echo $groupId."_".$groupMonth; ?>" class="newForm">Add</a>
    <?php if(count($memberBillingInfo)!=0) { ?>
    <span id="orangeText">|</span>
    <a href="javascript:void(0);" onclick="javascript:deleteRegInPay('i');" class="newForm">Remove</a>
    <?php } ?>
</div>
...
<div style="width:650px;">
	<div class="divRow" style="width:20px;padding-top:20px;" align="center"><span class="inActiveRecord">
    	<input type="checkbox" id="checkAll" onchange="javascript:checkUncheckAll(this,'checkRegIn');" class="checkBoxOpt"/></span></div>
...
<div style="width:650px;background-color:<?php echo $bgColor; ?>;" align="center" class="invoice_list">
	<div class="divRow" style="width:20px;" align="center"><span class="inActiveRecord">
    	<input type="checkbox" value="<?php echo $invoice_id;  ?>" id="<?php echo $invoice_id; ?>" onchange="changeCheckStyle(this);" name="checkRegIn" class="checkBoxOpt"/>
    </span></div>
