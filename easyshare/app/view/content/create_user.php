    ...
    <form id="imageInfo" action="upload.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="fileupload-buttonbar">
         <label class="fileinput-button" style="overflow:hidden;">
                 <img src="<?php echo $photoSrc; ?>" id="preview" width="110px" height="110px" alt="Easyshare Group" class="ui-button-text" style="background-color:#D6D6D6;" border="0"/>
...
<?php } else {	?>
	<div style="margin:50px 0 0 385px;position:absolute;background-color:#D6D6D6;border:1px solid #333;width:110px;height:110px;" align="center">
